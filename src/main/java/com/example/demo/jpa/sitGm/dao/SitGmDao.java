package com.example.demo.jpa.sitGm.dao;

import com.example.demo.jpa.sitGm.entity.PmPatchReg;
...
public interface SitGmDao extends JpaRepository<PmPatchReg, Long> {
